...
(function () {
  ...
  var T = EN ? {
    ...
    ariaAvatar: '프로필 이미지 업로드',
    ariaLike: '이 메시지에 공감', ariaReplyTo: '답글 대상: ',
    replyLabel: '답글', cancelLabel: '취소', postLabel: '게시',
    ipLabel: 'IP 지역: ',
    replyAtPrefix: '답글 @',
    replyPlaceholderPrefix: '답글 대상 @',
    count: function (n) { return n + ' / 500'; },
    submitted: '<b>게시했습니다.</b> 관리자의 승인 후 이곳에 표시됩니다 ✦',
    replySubmitted: '<b>답글을 게시했습니다.</b> 승인 후에 표시됩니다 ✦',
    postFail: '게시 실패: ', replyFail: '답글 실패: ',
    netFail: '네트워크 오류입니다. 잠시 후 다시 시도해 주세요.',
    timeout: '시간이 초과되었습니다. 연결 상태를 확인하고 다시 시도해 주세요.',
    loadFail: '메시지를 불러올 수 없습니다. 클릭하여 다시 시도합니다.',
    avatarUpdated: '<b>아바타를 변경했습니다.</b> 다음 게시물부터 표시됩니다 ✦',
    avatarFailPrefix: '아바타 업로드 실패: ',
    ...
    count: function (n) { return n + ' / 500'; },
    submitted: '<b>Отправлено.</b> Появится здесь после проверки владельцем сайта ✦',
    replySubmitted: '<b>Ответ отправлен.</b> Появится после проверки ✦',
    postFail: 'Не удалось отправить: ', replyFail: 'Не удалось ответить: ',
    netFail: 'Ошибка сети. Попробуйте позже.',
    timeout: 'Превышено время ожидания — проверьте соединение и попробуйте снова.',
    loadFail: 'Не удалось загрузить сообщения. Нажмите для повтора.',
    avatarUpdated: '<b>Аватар обновлён.</b> Он появится со следующим сообщением ✦',
    avatarFailPrefix: 'Ошибка загрузки аватара: ',
    ...
    count: function (n) { return n + ' / 500'; },
    submitted: '<b>Publicado.</b> Aparecerá aquí cuando el webmaster lo apruebe ✦',
    replySubmitted: '<b>Respuesta publicada.</b> Aparecerá cuando se apruebe ✦',
    postFail: 'Error al publicar: ', replyFail: 'Error al responder: ',
    netFail: 'Error de red. Inténtalo de nuevo más tarde.',
    timeout: 'Tiempo agotado — comprueba la conexión e inténtalo de nuevo.',
    loadFail: 'No se pudieron cargar los mensajes. Haz clic para reintentar.',
    avatarUpdated: '<b>Avatar actualizado.</b> Se mostrará con tu próximo mensaje ✦',
    avatarFailPrefix: 'Error al subir el avatar: ',
    ...
    count: function (n) { return n + ' / 500'; },
    submitted: '<b>Publié.</b> Apparaîtra ici une fois validé par le webmaster ✦',
    replySubmitted: '<b>Réponse publiée.</b> Apparaîtra une fois validée ✦',
    postFail: 'Échec de la publication : ', replyFail: 'Échec de la réponse : ',
    netFail: 'Erreur réseau. Réessayez plus tard.',
    timeout: 'Délai dépassé — vérifie ta connexion et réessaie.',
    loadFail: 'Impossible de charger les messages. Clique pour réessayer.',
    avatarUpdated: '<b>Avatar mis à jour.</b> Il apparaîtra avec ton prochain message ✦',
    avatarFailPrefix: "Échec du téléversement de l'avatar : ",
    ...
    replyPlaceholderPrefix: 'Responder a @',
    count: function (n) { return n + ' / 500'; },
    submitted: '<b>Publicado.</b> Aparecerá aqui quando o webmaster aprovar ✦',
    replySubmitted: '<b>Resposta publicada.</b> Aparecerá quando for aprovada ✦',
    postFail: 'Falha ao publicar: ', replyFail: 'Falha ao responder: ',
    netFail: 'Erro de rede. Tente novamente mais tarde.',
    timeout: 'Tempo esgotado — verifique a conexão e tente novamente.',
    loadFail: 'Não foi possível carregar as mensagens. Clique para tentar de novo.',
    avatarUpdated: '<b>Avatar atualizado.</b> Aparecerá com a sua próxima mensagem ✦',
    avatarFailPrefix: 'Falha ao enviar o avatar: ',
